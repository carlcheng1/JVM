...
size_t jump_one(u1 curr, const u1 *code_inst, const int32_t *stack, size_t pc, int s_i);

size_t jump_two(u1 curr, const u1 *code_inst, const int32_t *stack, size_t pc, int s_i);
